        ...
        <div className="p-4 md:p-6 lg:p-8 space-y-6 bg-background dark:bg-gray-900 min-h-screen">
            ...
            <div>
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
                    <div>
                        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-text-primary dark:text-white">Payments Management</h1>
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-3 md:mt-0">
                         {selectedPayments.length > 0 && (
                             <button onClick={handleBulkExport} className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-secondary-100 dark:bg-gray-700 text-text-primary dark:text-white rounded-lg hover:bg-secondary-200 dark:hover:bg-gray-600 text-sm">
                                 <Icon name="Download" size={16} />
                                 <span>Export ({selectedPayments.length})</span>
                             </button>
                         )}
                        <button onClick={handleCreatePaymentLink} className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-primary dark:bg-teal-500 text-white rounded-lg hover:bg-primary-700 dark:hover:bg-teal-600 text-sm">
            ...
            <div className="bg-surface dark:bg-gray-800 rounded-lg border border-border dark:border-gray-700 p-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <select 
                        ...
                        onChange={(e) => {
                            setFilters(prev => ({...prev, cryptocurrency: e.target.value}));
                            setCurrentPage(1);
                        }} 
                        className="w-full px-4 py-2 bg-background dark:bg-gray-900 border border-border dark:border-gray-600 rounded-lg dark:text-white"
                    >
                    ...
                    <select 
                        ...
                        onChange={(e) => {
                            setFilters(prev => ({...prev, network: e.target.value}));
                            setCurrentPage(1);
                        }} 
                        className="w-full px-4 py-2 bg-background dark:bg-gray-900 border border-border dark:border-gray-600 rounded-lg dark:text-white"
                    >
